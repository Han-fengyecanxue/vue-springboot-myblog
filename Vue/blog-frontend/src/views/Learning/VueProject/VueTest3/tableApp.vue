<template>
  ...
  <MyTable :goodsList="goodsList">
    ...
    <template #body="{ row, index }">
      ...
      <td>
        <img :src="row.goods_photos" alt="" width="50" height="50">
      </td>
...
const goodsList = ref([
  {
    id: 1,
    goods_name: '夏季专柜同款女鞋',
    goods_photos: ['/images/Learning/1.png'],
    goods_price: 298,
    tags: ['舒适', '透气'],
    inputVisible: false,
    inputValue: ''
  },
  {
    ...
    goods_photos: ['/images/Learning/2.png'],
    goods_price: 89,
    tags: ['保暖', '防滑'],
    inputVisible: false,
    inputValue: ''
  },
  {
    ...
    goods_photos: ['/images/Learning/3.png'],
    goods_price: 199,
    tags: ['秋冬', '毛衣'],
    inputVisible: false,
    inputValue: ''
  },
  {
    ...
    goods_photos: ['/images/Learning/4.png'],
    goods_price: 19,
    tags: ['雪纺衫', '打底'],
    inputVisible: false,
    inputValue: ''
  },
  {
    ...
    goods_photos: ['/images/Learning/5.png'],
    goods_price: 178,
    tags: ['圆领', '连衣裙'],
    inputVisible: false,
    inputValue: ''
